...
st.info("With over 500 active users, there were 6 instances of double booking when 2 villas booked the same court at the same time. The booking is made more robust. Check to see if any of your booking were affected in the double booking. The older of the 2 have been deleted.  ")    
