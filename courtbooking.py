...
st.info("Due to high server costs and limited donations, service will be intermittently paused to reduce loads on the DB. The app will permanently close on Dec 31, 2026.")
